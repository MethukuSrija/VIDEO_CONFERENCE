            ...
            while True:
                ...
                if t == "message":
                    ...
                    await manager.broadcast(str(room_id), {
                        ...
                        "user_picture": u.picture, "content": m.content, "is_ai_response": False,
                    ...
                    await manager.broadcast(str(room_id), {
                        ...
                        "user_picture": u.picture, "content": user_msg, "is_ai_response": False,
                    })
                    ...
                    await manager.broadcast(str(room_id), {
                        ...
                        "user_picture": None, "content": ai_text, "is_ai_response": True,
                    })
